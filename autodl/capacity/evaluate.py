...
COLS = ["slope_k_vs_n", "ARI_vs_human", "k_mean", "FM_vs_human", "k_median", "sil_median", "ch_median",
...
def main():
    ...
    for tag in tags:
        ...
        args = ck.get("args", {})
        net = AssignNet2(pairing=args.get("pairing", "meanmax"),
                         use_ncount=args.get("ncount", False),
                         use_gru=not args.get("no_gru", False)).to(dev)
