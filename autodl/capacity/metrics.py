"""
Evaluation metrics.
Two levels: (1) FM/ARI vs human (ARI primary -- FM rewards merging);
(2) emergent properties (never in loss): cluster count, silhouette, ch%,
two invariant slopes. HUMAN_REF provides baselines per condition.
"""
import numpy as np
